 ...
 print "<tr><td>";
	...
	print "<table width=\"100%\"><tr><td align=\"left\" width=\"25%\">";#   table for links and searchbox 
		  ...
		  if ($initial_record != 0) {
            ...
            $sort   = "sortfield=$sortfield&code=$code&description=$description&field1=$field1&field2=$field2&var1=$var1&user=$user";
...
print "<TR><TH>"; 
print "<CENTER><H3>$description - Displaying $junk to $next_index ";
print "of $number_of_records records</H3>";
print "</TH><TH><H3>$code</H3></TH></TR>\n";
    ...
    for ($iindex = 0;    ######  get records on this page
		...
		print "<a href=\"$PHP_SELF?action=UpdateData&key_ID=$key_ID&field1=$field1&field2=$field2&newvalue2=$record[$code]&newvalue1=$record[$description]&both=$both&var1=$var1&user=$user \">$record[$description]</a>";
		print "</H5></td>";
		print "<td align=right><H5><a href=\"$PHP_SELF?action=UpdateData&key_ID=$key_ID&field1=$field1&field2=$field2&newvalue2=$record[$code]&newvalue1=$record[$description]&both=$both&var1=$var1&user=$user\">$record[$code]</a>";
		print "</H5></td></tr>\n";
