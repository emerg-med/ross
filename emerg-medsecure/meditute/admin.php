<?php 
include('/home/httpd/html/meditute/common.inc');
...
case "Y":
	...
	$str_sql = " select *  from User where (Username = '$username' and Password = '$password' and Current = 'Yes') AND (UserType LIKE 'Admin')";
	...
	if (!$resultar){# if not superuser, check and see if non superuser with password and username
		...
		if (!$resultar){# authentication failed
			...
			include('/home/httpd/html/meditute/header.inc'); 
			include('/home/httpd/html/meditute/navbar.inc'); 
...
include('/home/httpd/html/meditute/footer.inc'); 
?>