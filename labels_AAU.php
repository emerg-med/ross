...
@Tbl
marginabove {0.5c}
aformat { @Cell width {7.0c} height {3.6c} A | @Cell width {7.0c} height {3.6c} B | @Cell width {7.0c} height {3.6c} ml {1.2c} C }
{
".$labelblock."
}
@LP
...
#	exec ("lout /tmp/" . $outputFileName . ".txt > /tmp/" . $outputFileName . ".ps");
	...
	exec ("lpr.cups -P 192.168.198.56 /tmp/" . $outputFileName . ".ps");
	exit();
